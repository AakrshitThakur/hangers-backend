...
import { adminSignupSchema, adminSigninSchema, } from "../../schemas/zod/admin-auth.zod.js";
dotenv.config();
...
function adminSignoutController(req, res) {
    try {
        // override jwt cookie
        res.cookie("jwt", "", {
            httpOnly: true,
...
//# sourceMappingURL=admin-auth.controllers.js.map